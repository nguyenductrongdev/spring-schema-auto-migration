...
Thanks for helping improve Cassandra Auto Migration.
...
Unsupported differences should be represented as reports, never executable CQL.
...
Please add focused tests for scanner, comparator, CQL ordering, and execution behavior when changing the migration core.
