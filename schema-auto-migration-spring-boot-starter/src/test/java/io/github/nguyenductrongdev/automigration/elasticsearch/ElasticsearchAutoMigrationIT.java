...
@SpringBootTest(
        classes = ElasticsearchAutoMigrationIT.TestApplication.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE,
        properties = "elasticsearch.auto-migration.mode=SAFE_UPDATE")
class ElasticsearchAutoMigrationIT {

    private static final String INDEX = "migration-customers";
    ...
    @Test
    void createsAndAdditivelyUpdatesMappingsIdempotently() {
